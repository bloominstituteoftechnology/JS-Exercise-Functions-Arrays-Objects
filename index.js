 ...
 * it will return `This is a Lincoln Navigator`.
*/
function getCarInfoById(array, carid) {
  const test = array[carid-1]
  return `This is a ${test.car_make} ${test.car_model}`
}
...
//     newarray.push(array[i].car_model);
// }
...
const sorted = array.sort((a, b) => (a.car_model > b.car_model) ? 1 : -1)
